...
import {selectCreditBond,queryFinanceBond,selectRateBond,selectPublicFundList,querySyndicatedLoan,selectTradeReceiptList} from '../../api/url'
  ...
  loadMoreData:function(){
      ...
      if(this.data.chooseIndex==1){
        ...
        data = {
          ...
          MARKET_SORT:this.data.btype,//项目名称

          DIRECTION_SORT:this.data.traded,//牵头行名称

          PUBLISH_TYPE_SORT:this.data.ptype,//借款人名称

          INTEREST_RATE_SORT:this.data.BOND_PROJECT_GRADE_SORT,//银团总额
          DEADLINE_SORT:this.data.INTEREST_RATE_RANGE_SORT,//期限

          MAIN_GRADE_SORT:this.data.BOND_NAME_SORT,//预计分销额度
          ISSUE_DATE_SORT:this.data.ISSUE_MODE_SORT,//预期收益率
