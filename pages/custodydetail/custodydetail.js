...
import {selectCreditBond,queryFinanceBond,selectRateBond,selectAssetCustodyInfo} from '../../api/url'
    ...
    this.setData({
      theme: wx.getSystemInfoSync().theme || 'light'
        ...
        this.setData({
            ...
            anchor: options.anchor  // 获取跳转过来的锚点id
        })
