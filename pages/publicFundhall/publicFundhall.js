...
import {selectCreditBond,queryFinanceBond,selectRateBond,selectPublicFundList} from '../../api/url'
  ...
  loadMoreData:function(){
      ...
      if(this.data.chooseIndex==1){
        ...
        data = {
          ...
          NAME_SORT:this.data.btype,//产品名称
          TYPE_SORT:this.data.traded,//投资类型
          ADMINISTRATOR_SORT:this.data.ptype,//管理人
          CUSTODIAN_SORT:this.data.BOND_PROJECT_GRADE_SORT,//托管人
          DEADLINE_SORT:this.data.sqlv,//期限
          SCALE_SORT:this.data.INTEREST_RATE_RANGE_SORT,//预期规模

          PURCHASE_SORT:this.data.BOND_NAME_SORT,//起购金额
          RANGE_SORT:this.data.ISSUE_MODE_SORT,//预期收益率区间
          DATE_SORT:this.data.INSUE_SCALE_SORT,//成立日期
          

          MODE_SORT:this.data.sortamount,//运作方式
          fbrq:this.data.fbrq,
          org_name_sort:this.data.org_name_sort   
        }
      }
