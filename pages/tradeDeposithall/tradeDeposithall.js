...
import {selectTradeFinanceList,queryTradeBorrow,selectTradeDepositList} from '../../api/url'
...
Page({
  ...
  loadMoreData:function(){
    let data = {
      ...
      DIRECTION_SORT:this.data.btype,
      DEADLINE_SORT:this.data.traded,
      INTEREST_RATE_SORT:this.data.ptype,
      AMOUNT_SORT:this.data.syqx,
      CURRENCY_SORT:this.data.sqlv,
      // AMOUNT_SORT:this.data.sortamount,
      fbrq:this.data.fbrq,
      org_name_sort:this.data.org_name_sort,
    ...
    selectTradeDepositList(data).then(res => {
      console.log(res);
      if(res.LIST){
        var list = res.LIST;
        console.log(list);
