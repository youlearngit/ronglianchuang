...
import {selectTradeFinanceList} from '../../api/url'
...
Page({
  ...
  loadMoreData:function(){
    let data = {
      ...
      TRAN_SORT:this.data.btype,
      NATURE_SORT:this.data.traded,
      DEADLINE_SORT:this.data.ptype,
      STANDARD_SORT:this.data.syqx,
      RATE_SORT:this.data.sqlv,
    ...
    selectTradeFinanceList(data).then(res => {
      console.log(res);
      if(res.LIST){
        var list = res.LIST;
        console.log(list);
