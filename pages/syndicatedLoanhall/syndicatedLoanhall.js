...
import {selectCreditBond,queryFinanceBond,selectRateBond,selectPublicFundList,querySyndicatedLoan} from '../../api/url'
  ...
  loadMoreData:function(){
      ...
      if(this.data.chooseIndex==1){
        ...
        data = {
          ...
          PROJECT_NAME_SORT:this.data.btype,//项目名称
          LEADING_BANK_NAME_SORT:this.data.traded,//牵头行名称
          BORROWER_NAME_SORT:this.data.ptype,//借款人名称
          TOTAL_SYNDICATION_SORT:this.data.BOND_PROJECT_GRADE_SORT,//银团总额
          TERM_SORT:this.data.INTEREST_RATE_RANGE_SORT,//期限

          DISTRIBUTION_QUOTA_SORT:this.data.BOND_NAME_SORT,//预计分销额度
          YIELD_SORT:this.data.ISSUE_MODE_SORT,//预期收益率
