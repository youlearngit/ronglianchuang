...
import {deletePublicFund,selectPublicFundList,querySyndicatedLoan,delSyndicatedLoan,queryTradeBorrow,delTradeBorrow,selectTradeReceiptList,deleteTradeReceipt,queryRegisterInfo} from '../../../api/url'
const app = getApp()
...
Page({
  ...
  delete(){
    deleteTradeReceipt({TDR_ID:this.data.info.TDR_ID}).then(res => {
      console.log(res);
      if(res.STATUS==1){
        wx.showToast({
          title: '删除成功',
