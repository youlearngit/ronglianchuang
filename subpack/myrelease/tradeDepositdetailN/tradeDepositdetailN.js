...
import {deletePublicFund,selectPublicFundList,querySyndicatedLoan,delSyndicatedLoan,queryTradeBorrow,delTradeBorrow,queryRegisterInfo,selectTradeDepositList} from '../../../api/url'
const app = getApp()
